...
TOKEN = '7801595281:AAG9Q06pUb6x12McntgDLOtsHFq_r0DUx9E'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002189068906
CHANNEL_ID = -1002189068906
error_channel_id = -1002189068906
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/download12456*", parse_mode='Markdown')
